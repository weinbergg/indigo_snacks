...
export const ozonProductUrl =
  'https://www.ozon.ru/product/indigo-sneks-3574361057/';
...
export const benefits = [
  ...
  {
    title: 'Удобный заказ',
    text: 'Каталог и переход на Ozon собраны так, чтобы покупка занимала минимум времени.',
    icon: 'order'
  }
];
...
export const orderingSteps = [
  {
    step: '01',
    title: 'Выберите фасовку',
    text: 'В каталоге доступны три фасовки: 50 г, 100 г и 500 г. Выберите подходящий формат для вашей собаки.'
  },
  {
    step: '02',
    title: 'Перейдите на Ozon',
    text: 'Нажмите кнопку покупки на сайте и перейдите в карточку товара на Ozon.'
  },
  {
    step: '03',
    title: 'Оформите заказ на маркетплейсе',
    text: 'На Ozon доступны безопасная оплата, привычное оформление и отслеживание доставки.'
  }
];
...
export const paymentOptions: Array<{
...
}> = [
  {
    ...
    label: 'Оплата через Ozon',
    hint: 'После оформления откроется защищенная страница оплаты Ozon Acquiring.'
  },
  {
...
export const legalNotice =
  'Покупка выполняется через Ozon: оплата и доставка оформляются на стороне маркетплейса.';
