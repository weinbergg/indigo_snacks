...
export const orderingSteps = [
  ...
  },
  {
    ...
    text: 'Соберите нужные позиции в корзину и перейдите на страницу заявки.'
  },
  {
    step: '03',
    title: 'Подтвердим детали',
    text: 'Мы свяжемся с вами и согласуем условия поставки, объем и формат сотрудничества.'
  }
];
...
export const legalNotice =
  'Для розничных заказов доступна покупка на Ozon, для B2B — заявка через сайт.';
